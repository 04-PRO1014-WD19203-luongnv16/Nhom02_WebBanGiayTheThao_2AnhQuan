...
function sua_bien_the_san_pham($id_san_pham, $size, $gia_nhap, $gia_ban, $sale, $so_luong) {
...
#lấy ra sale biến thể
function tim_sale_bien_the($id_san_pham,$id_size){
    $sql ="SELECT * FROM chi_tiet_san_pham WHERE id_san_pham = '$id_san_pham' AND id_size = '$id_size'";
    $bien_the = pdo_query_one($sql);
    return $bien_the['sale'];
}
