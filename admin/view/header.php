...
<li class="nav-item">
    ...
    <div id="collapseAccount" class="collapse" aria-labelledby="headingAccount" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Tất cả tài khoản</a>
            <a class="collapse-item" href="cards.html">Tài khoản đã xóa</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseOrder" class="collapse" aria-labelledby="headingOrder" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Tất cả đơn hàng</a>
            <a class="collapse-item" href="cards.html">Đơn hàng đã hủy</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseComment" class="collapse" aria-labelledby="headingComment" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Tất cả bình luận</a>
            <a class="collapse-item" href="cards.html">Bình luận đã xóa</a>
        </div>
    </div>
</li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Tên user</span>
